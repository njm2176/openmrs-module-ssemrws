...
public class WaterfallAnalysisController {
    ...
    public Object getWaterfallAnalysis(HttpServletRequest request, @RequestParam("startDate") String qStartDate,
                                       ...
                                       @RequestParam(required = false, value = "filter") SSEMRWebServicesController.filterCategory filterCategory) throws ParseException {
    ...
    private Object getWaterfallAnalysisChart(String qStartDate, String qEndDate) throws ParseException {
        ...
        List<GetTxNew.PatientEnrollmentData> activeClientsEntirePeriod = getTxCurr.getTxCurrPatients(null, dates[1]);

        // Get active clients for the last 30 days
        Calendar last30DaysCal = Calendar.getInstance();
        last30DaysCal.setTime(dates[0]);
