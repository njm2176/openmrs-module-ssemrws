...
// {
//
// private static final String PRIVILEGES_EXCEPTION_CODE =
...
// @Transactional
// @Override
// public Object getPatientsOnChildRegimenTreatment(String startDate, String
// endDate, List<String> regimenConceptUuids,
// String activeRegimenConceptUuid) {
// if (!validateIfUserHasSelfOrAllChildRegimenAccess()) {
// throw new
// APIAuthenticationException(Context.getMessageSourceService().getMessage(PRIVILEGES_EXCEPTION_CODE,
// new Object[] { VIEW_CHILD_REGIMEN_TREATMENT }, null));
// }
// return fetchPatients(startDate, endDate, regimenConceptUuids,
// activeRegimenConceptUuid);
// }
//
// private Object fetchPatients(String startDate, String endDate, List<String>
// regimenConceptUuids,
// String activeRegimenConceptUuid, String tx) {
// try {
// // Utilize the getPatientsOnRegimenTreatment method to handle the main data
// // processing
// return getPatientRegimens.getPatientsOnRegimenTreatment(startDate, endDate,
// regimenConceptUuids,
// activeRegimenConceptUuid);
// }
// catch (ParseException e) {
// log.error("Error parsing dates for fetching patients on regimen treatment: "
// + e.getMessage(), e);
// throw new RuntimeException("Failed to fetch patients on regimen treatment due
// to date parsing error.");
// }
// catch (Exception e) {
// log.error("Error fetching patients on regimen treatment: " + e.getMessage(),
// e);
// throw new RuntimeException("Failed to fetch patients on regimen treatment due
